...
namespace ConcealedGarden
{
    class CGCosmeticWater : UpdatableAndDeletable , IDrawable
    {
        ...
        {
            PlacedObjectsManager.RegisterManagedObject(new PlacedObjectsManager.ManagedObjectType("CGCosmeticWater",
                typeof(CGCosmeticWater), typeof(CGCosmeticWaterData), typeof(PlacedObjectsManager.ManagedRepresentation)));
        }
