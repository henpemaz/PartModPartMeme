...
namespace ConcealedGarden
{
    internal class CGDrySpot : UpdatableAndDeletable, IDrawable
    {
        ...
        {
            PlacedObjectsManager.RegisterManagedObject(new PlacedObjectsManager.ManagedObjectType("CGDrySpot",
                typeof(CGDrySpot), typeof(CGDrySpotData), typeof(PlacedObjectsManager.ManagedRepresentation)));
        }
        ...
        class CGDrySpotData : PlacedObjectsManager.ManagedData
        {
            ...
            public CGDrySpotData(PlacedObject owner) : base(owner, new PlacedObjectsManager.ManagedField[] {
