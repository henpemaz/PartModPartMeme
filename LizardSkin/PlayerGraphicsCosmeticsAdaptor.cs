...
namespace LizardSkin
{
    public class PlayerGraphicsCosmeticsAdaptor : GraphicsModuleCosmeticsAdaptor
    {
        ...
        public PlayerGraphicsCosmeticsAdaptor(PlayerGraphics pGraphics) : base(pGraphics)
        {
            ...
            List<LizKinCosmeticData> cosmeticDefs = LizardSkin.GetCosmeticsForSlugcat(pGraphics.player.abstractCreature.world.game.IsStorySession, (int)player.slugcatStats.name, player.playerState.slugcatCharacter, player.playerState.playerNumber);
