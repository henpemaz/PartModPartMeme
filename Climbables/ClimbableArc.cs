...
namespace Climbables
{
    public class ClimbableArc : UpdatableAndDeletable, IClimbableVine, IDrawable
    {
        ...
        {
            float heuristicDistance = (placedObject.data as PlacedObject.QuadObjectData).handles[0].magnitude;
            heuristicDistance += ((placedObject.data as PlacedObject.QuadObjectData).handles[1] - (placedObject.data as PlacedObject.QuadObjectData).handles[0]).magnitude;
            heuristicDistance += ((placedObject.data as PlacedObject.QuadObjectData).handles[2] - (placedObject.data as PlacedObject.QuadObjectData).handles[1]).magnitude;
            ...
            Vector2 posB = posA + (placedObject.data as PlacedObject.QuadObjectData).handles[0];
            Vector2 posC = posA + (placedObject.data as PlacedObject.QuadObjectData).handles[1];
            Vector2 posD = posA + (placedObject.data as PlacedObject.QuadObjectData).handles[2];
